...
public class ChonMenu extends JFrame implements ActionListener{
	JButton btnCauThu,btnBanHuanLuyen,btnDanhHieu,btnThoat;
	...
	private void addControls() {
		...
		JPanel pnTrangchu0=new JPanel();
		pnTrangchu0.setLayout(new BoxLayout(pnTrangchu0, BoxLayout.Y_AXIS));
		pnCenter.add(pnTrangchu0,BorderLayout.CENTER);
